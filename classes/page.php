...
class Page{
	...
	public function __construct($Uid='', $UuserId='', $Utitle='', $Usubtitle='', $Utext=0, $Uimage=''){
	...
	private function load(){
		$sql = "SELECT `id`, `text`, `userId`, `title`, `subtitle`, `image` FROM `pages` WHERE `id`=".$this->id.";";
		$con = $GLOBALS['SQL'];
	...
	public function insert(){
		...
		$sql = "INSERT INTO `pages`(`id`, `userId`, `text`, `title`, `subtitle`, `image`) VALUES ("
